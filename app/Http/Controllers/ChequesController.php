...
class ChequesController extends Controller
{
    ...
    public function index(Request $request){
    	...
    	if($request){
    		...
    		->orderBy('m.id','desc')
    		->get();
    		return view('banco.cheques.index', [
    ...
    public function pdfCheques(Request $request){
        ...
        if ($total_relatorio) {
            $pdf = PDF::loadView('reports/cheques/pdf_cheques',compact('empresas','mov_de_contas','total_relatorio','dtInicial','dtFinal','total_debito','total_credito'));
