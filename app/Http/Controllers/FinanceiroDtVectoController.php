...
class FinanceiroDtVectoController extends Controller
{
    ...
    public function index(Request $request){
        ...
        if($user->hasAnyRole('Admin','Gerente','Caixa')){        
                ...
                if($request){
                    ...
                    return view('reports.duplPagarDtVecto.index', [
        ...
        //dd($pagamentos,$idfornecedor_filtro);
         ...
         if ($idTodosFornecedores=='Todos') {
           ...
           // dd($pagamentos);
            ...
            $pdf = PDF::loadView('reports/duplPagarDtVecto/pdf_FinDtVencto',compact('empresas','pagamentos','total_relatorio',
            'dtInicial','dtFinal','nomefornecedor','codigorofornecedor'));
            return $pdf->setPaper('a4')->stream('todas_Dupl_por_vencimento.pdf');
