...
class ReceberBaixasController extends Controller
{
    ...
    public function index(Request $request){
    	...
    	if($request){
    		...
    		return view('reports.duplReceberBaixa.index', [
    			"recibos"=>$recibos,
    ...
    public function print(Request $request){
        ...
        if($request){
            ...
            return view('reports.duplReceberBaixa.print', [
                "recibos"=>$recibos,
                "proprietarios"=>$proprietarios,
                "imoveis"=>$imoveis,
                "inquilinos"=>$inquilinos,
    ...
    public function printBaixas(Request $request){
        ...
        if ($total_relatorio) {
            $pdf = PDF::loadView('reports/duplReceberBaixa/pdf_receber_pagamentos',compact('empresas','recibos','total_relatorio','dtInicial','dtFinal'));
