...
class AlugueisAtrasadosController extends Controller
{
    ...
    public function index(Request $request){
    	...
    	if($request){
    		...
    		return view('reports.alugueis_atrasados.index', [
    			"recibos"=>$recibos,
    ...
    public function print(Request $request){
        ...
        if($request){
            ...
            return view('reports.alugueis_atrasados.print', [
                "recibos"=>$recibos,
                "proprietarios"=>$proprietarios,
                "imoveis"=>$imoveis,
                "inquilinos"=>$inquilinos,
    ...
    public function pdfAlugueisAtrasados(Request $request){
        ...
        if ($total_relatorio) {
            $pdf = PDF::loadView('reports/alugueis_atrasados/pdf_alugueis_atrasados',compact('empresas','recibos','total_relatorio','dtInicial','dtFinal'));
            return $pdf->setPaper('a4')->stream('todos_alugueis_atrasado.pdf');
        }
