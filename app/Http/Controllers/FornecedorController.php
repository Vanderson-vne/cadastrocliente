...
class FornecedorController extends Controller
{
    ...
    public function index(Request $request){
        ...
        if($request){
            ...
            ->where('i.for_cli','=','Fornecedor')
            ->where('i.condicao','=','Ativo')
            ->orderBy('i.id','desc')
    		->get();
    		return view('financeiro.fornecedor.index', [
    ...
    public function create(){
    	...
    	return view("financeiro.fornecedor.create",[
    		]);
    }
    ...
    public function store(PessoaDuplFormRequest $request){
        ...
        $fornecedor->for_cli='Fornecedor'; 
        $fornecedor->condicao='Ativo';
    	$fornecedor->save();
    	return Redirect::to('financeiro/fornecedor');
    }

    public function show($id){
    	return view("financeiro.fornecedor.show",
 	...
 	public function edit($id){
    	...
    	return view("financeiro.fornecedor.edit",
    		["fornecedor"=>PessoaDupl::findOrFail($id)]);
    }
