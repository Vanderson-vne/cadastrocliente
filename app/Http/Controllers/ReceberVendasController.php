...
class ReceberVendasController extends Controller
{
...
//dd($pagamentos);
        ...
        if($request){
            ...
            'p.nome as nomefor','i.idimovel','i.endereco as endimovel', 'o.nome as nomepro')
            ->where('pagar_receber','=','Receber')
            ...
            return view('financeiro.receberVendas.index', [
    ...
    public function create(){
        ...
        return view("financeiro.receberVendas.create",[
            "classificacoes"=>$classificacoes,
            "fornecedores"=>$fornecedores,
            "imoveis"=>$imoveis,
        ]);
    ...
    public function store(FinanceiroFormRequest $request){
        ...
        $pagar->pessoa_vend_id=$request->get('pessoa_dupls_id');
        ...
        $pagar->pagar_receber='Receber';
        $pagar->save();

        return Redirect::to('financeiro/receberVendas');
    }


    public function show($id){
    	return view("financeiro/receberVendas.show",
    ...
    public function edit($id){
        ...
        'c.nome as nomeclas','p.id as idfor','p.nome as nomefor','f.imovel_id', 
        'i.idimovel','i.endereco as endimovel', 'o.nome as nomepro')
        ->where('pagar_receber','=','Receber')
        ->orderBy('id','desc')
        ->get();

    	return view("financeiro/receberVendas.edit",
    ...
    public function update(FinanceiroFormRequest $request, $id){
        ...
        if ($pagamento == null) {
            //Movimentação Mov_contas
                ...
                $trans=$request->get('idtransacao'); //Transaçao de Credito
                $transacoes=DB::table('transacao as tra')
